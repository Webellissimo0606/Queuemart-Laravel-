...
<div class="row">
    <div class="col-2 offset-1" style="border: 3px solid black; padding: 10px;color: white;font-weight: bold;font-size: 15px; text-align: center;background-color: #ffc107;">Booked</div>
    <div class="col-2" style="border: 3px solid black; padding: 10px;color: white;font-weight: bold;font-size: 15px; text-align: center;background-color: #fd7e14;">Paid</div>
    <div class="col-2" style="border: 3px solid green; padding: 10px;color: black;font-weight: bold;font-size: 15px; text-align: center;background-color: white;">Arrived</div>
    <div class="col-2" style="border: 3px solid green; padding: 10px;color: white;font-weight: bold;font-size: 15px; text-align: center;background-color: #7460ee;">Working</div>
    <div class="col-2" style="border: 3px solid green; padding: 10px;color: white;font-weight: bold;font-size: 15px; text-align: center;background-color: #76c100;">Completed</div>
</div>