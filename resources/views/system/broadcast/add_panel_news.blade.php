<div class="modal fade" id="add_panel_news" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ URL::to('admin/addPanelNews')}}" method="POST" id="add_panel_news_form" enctype="multipart/form-data">
	            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="news_image" type="file" name="news_image">
                    </div>
                    <div class="form-group">
	            ...
	            <div class="modal-footer">
	                <button type="submit" class="btn btn-primary add_panel_news_btn"><i class="fa fa-check"></i> Save</button>
